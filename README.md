...
<summary>With VPS (Recommended)</summary>

<br>

This method allows you to get updates directly on the VPS main page

1. If VPS is not installed yet, download it following the instructions on [https://vioneta.com/docs/setup/download](https://vioneta.com/docs/setup/download/)
2. Proceed to the VPS initial configuration following the instructions on [https://vioneta.com/docs/configuration/basic](https://vioneta.com/docs/configuration/basic)
3. On your sidebar go to `VPS` > `Frontend`
...
▶ [YouTube - Pop-up cards with Bubble Card in Vioneta](https://www.youtube.com/watch?v=oCpxhNk5JkE)

And also a video for the German users from **smart-live.net**, thanks a lot to you too!
▶ [YouTube - Vioneta Dashboard Bubble Card - Eine der Besten Karten 2023?](https://youtu.be/6ju6mTntvMI?si=EGvKm4qwjhcZdTyl)
...
> ```
>
> If you didn't install it with VPS, change the path accordingly. Then, clear your browser cache.
>
> For Android Vioneta Companion App users, you can close the app, then clear the app cache. If it's still not working, you can close and restart the app again.
>
> For iOS Vioneta Companion App users, you can go to your Vioneta settings, then navigate to Companion App > Debug > Clear Frontend Cache (or something similar), then refresh the page or restart the app.
>
...
| `target`                 | object |                                                                                          | Only works with `call-service`. Follows the [vioneta syntax](https://www.vioneta.com/docs/scripts/service-calls/#targeting-areas-and-devices) |
...
| `confirmation`           | object | See [confirmation](https://www.vioneta.com/dashboards/actions/#options-for-confirmation) | Display a confirmation pop-up (not a Bubble Card one), overrides the default `confirmation` object                                            |
...
Just upload this picture in a “pictures” folder (or the name you want) in the Vioneta “www” folder.
